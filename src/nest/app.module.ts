 ...
 *
 * Serve `games` (PRs 3 e 4) e `lists` (PR 5). `suppliers` entra no PR 6
 * (`docs/NEST.md` §5); produção segue no Express até o PR 9.
 *
 ...
 */
@Module({
	imports: [AppConfigModule, GamesModule, ListsModule],
