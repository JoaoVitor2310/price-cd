...
| A Lista tem jogos de outra plataforma (ex.: seção `GOG:`) | Ignora só esses jogos e segue com os da Steam — o preço de key de outra loja é diferente e ainda não sabemos buscar |
