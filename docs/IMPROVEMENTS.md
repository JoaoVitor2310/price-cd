...
3. **Porta `AlertNotifier` — acabar com as falhas silenciosas** — princípio do projeto: nenhuma falha pode ficar só no log. É pré-requisito do item 5. Estrutura sugerida:
...
17. **Divergências de transporte entre Express e Nest, aceitas conscientemente** — nas rotas já migradas, requisição malformada em nível de transporte responde diferente nos dois apps:
